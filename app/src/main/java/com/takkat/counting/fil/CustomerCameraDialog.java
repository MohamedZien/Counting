...
public class CustomerCameraDialog  extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.customer_camera_dialog, container, false);
    ...
    private void definitionId() {
        ...
        evalId = args.getInt("idEv");

        imageView = view.findViewById(R.id.image_customer_camera_dialog);
        clear = view.findViewById(R.id.clear_url_customer_camera_dialog);
        clear.setVisibility(View.INVISIBLE);
        mProgress = view.findViewById(R.id.progress_bar_wait_upload_image_customer_camera_dialog);
        mProgress.setVisibility(View.INVISIBLE);
        button = view.findViewById(R.id.btn_save_photo_in_customer_camera_dialog);
        button.setVisibility(View.INVISIBLE);
        addImage = view.findViewById(R.id.add_image_in_request_customer_camera_dialog);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Toast.makeText(getContext(), " " + evalId, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        switch (requestCode) {
            ...
            case LOCATION_REQEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getContext(), "من فضلك تشغيل الصلاحيه", Toast.LENGTH_SHORT).show();
                }
                break;
            }
        }
            ...
            switch (requestCode) {
                ...
                case CAMERA_REQUEST_CODE:
                    ...
                    if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
                        ...
                        Uri tempUri = getImageUri(getActivity(), compressedBitmap);
    ...
    class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
                ...
                addImage.setVisibility(View.VISIBLE);
                imageView.setImageResource(R.drawable.ic_camera_enhance_blue_220dp);
                Toast.makeText(getContext(), "تم حفظ الصوره...", Toast.LENGTH_SHORT).show();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        addImage.setVisibility(View.VISIBLE);
                        imageView.setImageResource(R.drawable.ic_camera_enhance_blue_220dp);
                        Toast.makeText(getActivity(), "تم حفظ الصوره...", Toast.LENGTH_SHORT).show();
                        // uploadSetUnderRevsion();
                        dialog.dismiss();
